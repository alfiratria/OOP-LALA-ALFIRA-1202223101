public class Ekspedisi {
    ...
    protected int jumlahCabang; String pusat; float tarif;
    ...
    public void Informasi(){
        System.out.println("Ekspedisi TelUExpress dengan Jumlah cabang" + jumlahCabang + "dan berpusat di" + pusat + " mempunyai tarif sebesar " + tarif);
    }
}
